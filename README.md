...
- Commits go to the `dev` branch → auto-deploys to staging
...
functions/
  ...
  api/articles/         Legacy article API (publish.js still used by the
                        /yllapito promote button; list/get/delete unused)
