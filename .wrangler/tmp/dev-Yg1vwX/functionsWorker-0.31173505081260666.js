...
// .wrangler/tmp/bundle-yUlKyz/checked-fetch.js
...
// .wrangler/tmp/pages-TZevjR/functionsWorker-0.31173505081260666.mjs
...
__name2(verifyAnswer, "verifyAnswer");
...
__name2(destroyAllSessionsForUser, "destroyAllSessionsForUser");
...
__name2(getSessionCookieHeader, "getSessionCookieHeader");
function getClearSessionCookieHeader() {
  return `${SESSION_COOKIE_NAME}=; HttpOnly; Secure; SameSite=Strict; Path=/; Max-Age=0`;
}
__name(getClearSessionCookieHeader, "getClearSessionCookieHeader");
__name2(getClearSessionCookieHeader, "getClearSessionCookieHeader");
...
__name2(requireAuthOrLegacyPassword, "requireAuthOrLegacyPassword");
...
__name2(validateSecurityQuestion, "validateSecurityQuestion");
...
__name2(validateSecurityAnswer, "validateSecurityAnswer");
var DECOY_QUESTIONS = [
...
__name2(getDecoyQuestions, "getDecoyQuestions");
...
__name2(getJsonBody, "getJsonBody");
var CORS_HEADERS = {
...
__name2(countActiveAdmins, "countActiveAdmins");
...
__name(logAttempt2, "logAttempt2");
__name2(logAttempt2, "logAttempt");
...
__name2(formatTitleFromSlug, "formatTitleFromSlug");
...
__name2(getInstallationToken, "getInstallationToken");
...
__name2(wrapPkcs1AsPkcs8, "wrapPkcs1AsPkcs8");
...
__name2(derLengthHeader, "derLengthHeader");
...
__name2(b64urlEncodeJson, "b64urlEncodeJson");
...
__name(base64ToBytes3, "base64ToBytes3");
__name2(base64ToBytes3, "base64ToBytes");
...
__name(bytesToBase642, "bytesToBase642");
__name2(bytesToBase642, "bytesToBase64");
function utf8ToBase64(str) {
  return bytesToBase642(new TextEncoder().encode(str));
}
__name(utf8ToBase64, "utf8ToBase64");
__name2(utf8ToBase64, "utf8ToBase64");
...
__name2(utf8ToBase64Url, "utf8ToBase64Url");
...
__name(importPrivateKey2, "importPrivateKey2");
__name2(importPrivateKey2, "importPrivateKey");
...
__name(signAppJwt2, "signAppJwt2");
__name2(signAppJwt2, "signAppJwt");
...
__name(getInstallationToken2, "getInstallationToken2");
__name2(getInstallationToken2, "getInstallationToken");
...
__name2(createCommit, "createCommit");
...
__name2(updateBranch, "updateBranch");
...
__name2(fetchManifest, "fetchManifest");
...
__name2(commitChanges, "commitChanges");
...
__name2(actionListGalleryPhotos, "actionListGalleryPhotos");
...
__name2(actionDeletePhoto, "actionDeletePhoto");
...
__name2(actionUpdateCaption, "actionUpdateCaption");
...
__name2(actionDeleteGallery, "actionDeleteGallery");
...
__name2(actionRenameGallery, "actionRenameGallery");
...
__name2(actionMovePhoto, "actionMovePhoto");
...
__name(badRequest2, "badRequest2");
__name2(badRequest2, "badRequest");
...
__name(serverError2, "serverError2");
__name2(serverError2, "serverError");
...
__name(base64ToBytes4, "base64ToBytes4");
__name2(base64ToBytes4, "base64ToBytes");
...
__name(bytesToBase643, "bytesToBase643");
__name2(bytesToBase643, "bytesToBase64");
function utf8ToBase642(str) {
  return bytesToBase643(new TextEncoder().encode(str));
}
__name(utf8ToBase642, "utf8ToBase642");
__name2(utf8ToBase642, "utf8ToBase64");
function bytesToBase64Url3(bytes) {
  return bytesToBase643(bytes).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "");
}
__name(bytesToBase64Url3, "bytesToBase64Url3");
__name2(bytesToBase64Url3, "bytesToBase64Url");
function utf8ToBase64Url2(str) {
  return bytesToBase64Url3(new TextEncoder().encode(str));
}
__name(utf8ToBase64Url2, "utf8ToBase64Url2");
__name2(utf8ToBase64Url2, "utf8ToBase64Url");
...
__name2(buildFilename, "buildFilename");
function sanitizeSlug2(slug) {
  return String(slug || "").toLowerCase().replace(/[^a-z0-9-]/g, "-").replace(/-+/g, "-").replace(/^-|-$/g, "");
}
__name(sanitizeSlug2, "sanitizeSlug2");
__name2(sanitizeSlug2, "sanitizeSlug");
...
__name(formatTitleFromSlug2, "formatTitleFromSlug2");
__name2(formatTitleFromSlug2, "formatTitleFromSlug");
...
__name2(determineCategory, "determineCategory");
...
__name(importPrivateKey3, "importPrivateKey3");
__name2(importPrivateKey3, "importPrivateKey");
...
__name(signAppJwt3, "signAppJwt3");
__name2(signAppJwt3, "signAppJwt");
...
__name(getInstallationToken3, "getInstallationToken3");
__name2(getInstallationToken3, "getInstallationToken");
...
__name(getBranchHead2, "getBranchHead2");
__name2(getBranchHead2, "getBranchHead");
async function getCommit2(token, commitSha) {
  return gh2(token, `/repos/${REPO_OWNER}/${REPO_NAME}/git/commits/${commitSha}`);
}
__name(getCommit2, "getCommit2");
__name2(getCommit2, "getCommit");
...
__name(createBlob2, "createBlob2");
__name2(createBlob2, "createBlob");
...
__name(createTree2, "createTree2");
__name2(createTree2, "createTree");
...
__name(createCommit2, "createCommit2");
__name2(createCommit2, "createCommit");
...
__name(updateBranch2, "updateBranch2");
__name2(updateBranch2, "updateBranch");
...
__name2(fileExists, "fileExists");
function targetBranch2(env) {
  const b = env.CF_PAGES_BRANCH || env.CF_PAGES_TARGET_BRANCH || "";
  if (b === "main") return "main";
  return "dev";
}
__name(targetBranch2, "targetBranch2");
__name2(targetBranch2, "targetBranch");
...
// .wrangler/tmp/bundle-yUlKyz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-yUlKyz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.31173505081260666.js.map
